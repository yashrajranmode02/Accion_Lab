import { p as prop, i as if_block, d as bind_this, a as set_attribute } from './i18n-CGlVUOvE.js';
import { ai as delegate, M as push, a8 as onMount, af as onDestroy, Q as child, T as reset, S as sibling, t as template_effect, X as set_text, a as append, O as pop, Z as get, R as from_html, a2 as user_derived, f as from_svg } from './index-Bq2njFOY.js';
import { f as format_time } from './utils.svelte-Bi9ASwv9.js';
...
function MinimalAudioPlayer($$anchor, $$props) {
	...
	const create_waveform = async () => {
		if (!container || !get(resolved_src) || waveform_ready) return;
...

	{
		...
		if_block(node, ($$render) => {
			if (playing) $$render(consequent); else $$render(alternate, false);
		});
	}
	...
	template_effect(
		($0, $1) => {
			...
			set_attribute(button, 'aria-label', playing ? "Pause" : "Play");
			set_text(text, $1);
		},
		[
...
//# sourceMappingURL=MinimalAudioPlayer-BNuZEaxr.js.map
