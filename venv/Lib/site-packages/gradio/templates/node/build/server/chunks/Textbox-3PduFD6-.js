...
function Textbox($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (submit_btn) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<button${attr_class("submit-button svelte-1hguek3", void 0, { "padded-button": submit_btn !== true })}>`);
      if (submit_btn === true) {
        $$renderer2.push("<!--[-->");
        Send($$renderer2);
      } else {
    ...
    if (stop_btn) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<button${attr_class("stop-button svelte-1hguek3", void 0, { "padded-button": stop_btn !== true })}>`);
      if (stop_btn === true) {
        $$renderer2.push("<!--[-->");
...
export { Textbox as T };
//# sourceMappingURL=Textbox-3PduFD6-.js.map
